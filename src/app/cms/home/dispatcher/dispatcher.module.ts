...
@NgModule({
  declarations: [
    ...
    DispatcherRidersListComponent,
    DispatcherLocationsSelectComponent,
    DispatcherServiceSelectComponent,
    DispatcherLookingComponent,
    DispatcherSuccessDriverInfoComponent,
  ],
  imports: [CommonModule, DispatcherRoutingModule, SharedModule],
